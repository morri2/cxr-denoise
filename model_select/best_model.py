...
def select_best_epoch(csv_path, metrics, lower_is_better_flags, use_multiplicative=True):
    """
    ...
    Args:
        ...
        lower_is_better_flags (list of bool): True if corresponding metric is lower-is-better.
    ...
    # --- Rank each metric ---
    for metric, lower_is_better in zip(metrics, lower_is_better_flags):
